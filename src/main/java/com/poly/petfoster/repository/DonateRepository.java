...
public interface DonateRepository extends JpaRepository<Donate, Integer> {
    ...
    List<Donate> filterAdminDonates(@Param("search") Optional<String> search, @Param("minDate") Optional<Date> minDate,
            @Param("maxDate") Optional<Date> maxDate, @Param("sort") Optional<String> sort);
