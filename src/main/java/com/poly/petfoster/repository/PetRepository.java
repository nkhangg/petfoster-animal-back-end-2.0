...
public interface PetRepository extends JpaRepository<Pet, String> {
    ...
    List<Pet> filterPets(@Param("name") String name, @Param("typeName") String typeName, @Param("colors") String colors,
        ...
        @Query("SELECT p " +
            ...
            "CASE WHEN :sort = 'oldest' THEN p.fosterAt END ASC, " +
            "CASE WHEN :sort = 'latest' THEN p.fosterAt END DESC")
            List<Pet> filterAdminPets(@Param("name") String name, @Param("typeName") String typeName, @Param("colors") String colors,
            @Param("age") String age, @Param("gender") Boolean gender, @Param("status") String status, @Param("minDate") Date minDate, @Param("maxDate") Date maxDate, @Param("sort") String sort);
