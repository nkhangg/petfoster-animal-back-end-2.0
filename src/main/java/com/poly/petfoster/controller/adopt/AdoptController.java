...
public class AdoptController {
    ...
    @PostMapping("/{id}")
    public ResponseEntity<ApiResponse> cancelAdoptByUser(@PathVariable Integer id, @RequestHeader("Authorization") String jwt, @Valid @RequestBody CancelAdoptRequest cancelAdoptRequest) {
