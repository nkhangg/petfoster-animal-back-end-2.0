...
public class TransactionServiceImpl implements TransactionService {
    ...
    public Donate builDonate(TransactionRequest transactionRequest) {
        return Donate.builder()
                ...
                .donater(transactionRequest.getCorresponsiveAccount())
    ...
    public ApiResponse getTransaction(Optional<Integer> page) {
        ...
        return ApiResponse.builder()
                ...
                .errors(false)
                .status(HttpStatus.OK.value())
                .data(PagiantionResponse.builder().data(visibleDonation).pages(pagination.getTotalPages()).build())
                .build();
    }
    ...
    public ApiResponse filterTransaction(Optional<String> search, Optional<Date> minDate, Optional<Date> maxDate,
        ...
        List<Donate> donates = donateRepository.filterAdminDonates(search, minDate, maxDate, sort);
        ...
        return ApiResponse.builder()
                ...
                .errors(false)
                .status(HttpStatus.OK.value())
                .data(TransactionFilterResponse.builder().data(visibleDonation).pages(pagination.getTotalPages())
                        .total(total).build())
                .build();
    }
